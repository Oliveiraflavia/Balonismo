...
public class Balao {
        ...
        public Balao(int id, String registros, String cor, String tipo, double altura, double peso, int capacidade, double valorBalao) {
                this.id = id;
        ...
        public Balao(String registros, String cor, double altura, double peso) {
                this.registros = registros;
                this.cor = cor;
                this.altura = altura;
                this.peso = peso;
